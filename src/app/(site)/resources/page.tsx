...
import { NATIONAL } from "@/content/resources";
      ...
      <section className="section-pad stagger">
        <div className="content-container">
          ...
          <p className="section-body reveal" data-i="2">
            Activity is volatile rather than smoothly increasing, which is why the
            two most recent years are shown side by side rather than joined.
          </p>
          <div className="reveal" data-i="3">
            <AcreageVolatility />
          </div>
        </div>
        <dl className="figure-list reveal" data-i="4">
          {NATIONAL.map((figure) => (
